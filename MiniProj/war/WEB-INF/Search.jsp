...
<body class="weocome-holder">
	...
	<div class="container-fluid">
		...
		<div id="sidebar">
			...
			<form class="navbar-form navbar-left" role="search" action="/searchChallenges" onclick="return false">
  ...
  List<Entity> challenges = (List<Entity>)request.getAttribute("challengesList");
  if(challenges!=null){
	  out.println("hai if");
